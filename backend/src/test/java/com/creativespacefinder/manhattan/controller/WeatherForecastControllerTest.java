...
//
//    @Test
//    @DisplayName("GET /api/forecast with unsupported Accept → 200 OK")
//    void getForecast_wrongAccept_returns200() throws Exception {
//        mvc.perform(get("/api/forecast")
...
//        // arrange: dummy ForecastResponse
//        ForecastResponse fake = new ForecastResponse();
//        // mock the no-arg service method
